...
当你需要创建一个新的 Cocos Creator 游戏项目时，推荐从 `skills/cocos-project-setup/new_project_code/` 模板拷贝代码：
...
3. 将 skills/cocos-project-setup/new_project_code/script/      拷贝到  项目/assets/script/
4. 将 skills/cocos-project-setup/new_project_code/GameBundle/   拷贝到  项目/assets/GameBundle/
...
模板的详细技术文档见 `skills/cocos-project-setup/new_project_code/TECHNICAL_DOC.md`。
...
不可以。`playbook-cocos` 是文档优先的知识库，不包含可运行的游戏应用。`skills/cocos-project-setup/new_project_code/` 中的代码是模板，需要拷贝到实际的 Cocos Creator 项目中才能使用。
...
### Q: skills/cocos-project-setup/new_project_code 模板和技能文档中的代码哪个优先？

`skills/cocos-project-setup/new_project_code/` 中的代码是实际可用的模板，是最新的参考实现。技能文档中的代码示例用于解释概念，可能经过简化。创建新项目时以模板代码为准。
