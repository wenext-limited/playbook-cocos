...
│   ├── 架构总览.md              # 架构全景
│   ├── 使用说明.md              # 本文件
│   └── Cocos CK 上报查询使用文档.md # Cocos 埋点查询使用说明
...
3. **`docs/架构总览.md`** — 了解项目架构设计

如果需要先把知识库安装到本机用户级目录，再投喂给 AI，请阅读 **`AI本机安装.md`**。
...
| 查询 Cocos CK 上报、玩家人数和错误率 | `skills/cocos-query-ck/SKILL.md`；`docs/Cocos CK 上报查询使用文档.md` |
| 同步本仓库或提交变更 PR | `skills/cocos-playbook-sync/SKILL.md` |
